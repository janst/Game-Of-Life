...
var GameOfLife = {
	...
	numOfNeighbours: function (aBoardPoint) {
		...
		// Todo: validate on border conditions
	...
	sizeOfSquare: function(){
		...
		// Todo: Should handle error in a validation function after all default values are being set.
...
GameOfLife.drawSquareFromMousePoint = function (pointX, pointY){
	// Todo: Kunne vi hatt denne koden i en funksjon?
